          ...
          >
            {user.isLoggedIn ? (
              ...
              <>
                ...
                <span className="text-xs font-medium text-nowrap">Login / Sign-up</span>
              </>
            )}
          </div>
      ...
      {showDialog && (
        <div
          ...
          <ul className="space-y-3 mt-2">
            <li className="flex items-center gap-2 cursor-pointer"><FaUser /> My Profile</li>
            <li className="flex items-center gap-2 cursor-pointer"><BiMessageRoundedDetail /> Message</li>
            <li className="flex items-center gap-2 cursor-pointer"><FaHeart /> Favourite</li>
            <li className="flex items-center gap-2 cursor-pointer"><MdOutlineRateReview /> My Reviews</li>
            <li className="flex items-center gap-2 cursor-pointer"><BsFileEarmarkText /> My RFQ</li>
            <li className="flex items-center gap-2 cursor-pointer"><FaGlobeAsia /> Browsing History</li>
            <li className="flex items-center gap-2 cursor-pointer"><FaSignInAlt /> Sign In</li>
          </ul>
        </div>
      )}
    </header>
