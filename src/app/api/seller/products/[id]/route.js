...
export async function PATCH(request, { params }) {
    try {
        ...
        if (!user || user.role !== "seller") return NextResponse.json({ message: "Forbidden" }, { status: 403 });
        ...
        fields.forEach((field) => {
            ...
            if (value) {
                product[field] = ["price", "minOrderQuantity"].includes(field) ? parseFloat(value) : value;
            }
        });
